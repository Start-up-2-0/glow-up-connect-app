...
export const modulosRoutes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    name: ROUTE_NAMES.FINANCEIRO_MINHAS_COMISSOES,
    component: () => import('@/views/modulos/financeiro/MinhasComissoesView.vue'),
    meta: {
      layout: 'dashboard',
      requiresAuth: true,
      businessOnly: true,
  ...
  },
  {
    ...
    name: ROUTE_NAMES.FINANCEIRO_CONTAS_RECEBER,
    component: () => import('@/views/modulos/financeiro/ContasReceberView.vue'),
    meta: {
      layout: 'dashboard',
      requiresAuth: true,
      businessOnly: true,
  ...
  },
  {
    ...
    name: ROUTE_NAMES.FINANCEIRO_CONTAS_PAGAR,
    component: () => import('@/views/modulos/financeiro/ContasPagarView.vue'),
    meta: {
      layout: 'dashboard',
      requiresAuth: true,
      businessOnly: true,
