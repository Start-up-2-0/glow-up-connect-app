...
const MARKETPLACE_ITENS = [
  { publicGuid: PUBLIC_GUID, nome: 'Studio Glow Up', logo: 'https://images.unsplash.com/photo-1560066984-138dadb4c035?w=96&h=96&fit=crop&auto=format', descricao: 'Salão completo de beleza.', distanciaKm: 0.8, endereco: ENDERECO, destaqueMarketplace: true, notaMedia: 4.8, totalAvaliacoes: 68, categoriaId: 18, categoria: 'Salão de Beleza', tipoAssinatura: 'Estabelecimento' as const, latitude: -10.9472, longitude: -37.0731 },
