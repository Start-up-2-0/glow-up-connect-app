...
<template>
  <div class="flex flex-col gap-2">
    <span
      class="text-glow-text"
      :class="isContratar ? 'font-urbanist text-sm' : 'font-urbanist text-sm font-medium'"
    >
      {{ label }}
    </span>
    <div class="flex flex-wrap gap-2">
      <button
        ...
        :class="
          isContratar
            ? [
                'onboarding-contratar-vencimento-btn',
                modelValue === dia ? 'onboarding-contratar-vencimento-btn--active' : '',
              ]
            : [
